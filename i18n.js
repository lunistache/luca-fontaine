...
(function () {
  ...
  const I18N = {
    ...
    en: {
      ...
      "nav.contact": "Contact",
      "home.role": "Actor",
      "headshot.eyebrow": "Headshots",
      "headshot.title": "Photography",
      "resume.title": "Resume",
      "approach.eyebrow": "Approach",
      "approach.title": "My Approach",
      "approach.body": "[ Approach text to come — to be provided by Luca. ]",
      "coaching.book": "Book a session",
      "meta.title.book": "Book a session — Luca Fontaine",
      "book.eyebrow": "Coaching",
      "book.title": "Book a session",
      "book.lede": "Tell me about your project and what you're preparing. Enquiries here come straight to me — not through management — and I'll get back to you directly.",
      "book.name": "Name",
      "book.email": "Email",
      "book.project": "Project / production",
      "book.optional": "optional",
      "book.service": "What do you need?",
      "book.svc.dialect": "Dialect coaching",
      "book.svc.audition": "Audition & role prep",
      "book.svc.selftape": "Self-tape prep",
      "book.svc.accent": "Accent reduction & speech",
      "book.svc.speaking": "Public speaking",
      "book.svc.other": "Other",
      "book.timeline": "Timeline / preferred dates",
      "book.message": "Tell me about the project",
      "book.submit": "Send request",
      "coaching.video.eyebrow": "Featured",
      "coaching.video.label": "Luca Fontaine featured on Live with Kelly and Mark.",
      ...
      "coaching.title": "Dialect & Acting Coach",
      ...
      "coaching.cta.btn": "Book a session",
      ...
      "contact.formbtn": "Contact me",
      "meta.title.cform": "Contact me — Luca Fontaine",
      "cform.eyebrow": "Contact",
      "cform.title": "Contact me",
      "cform.lede": "Drop me a message and I'll get back to you as soon as I can.",
      ...
      "footer.meta": "Actor • Writer • Coach"
    },
    ...
    it: {
      ...
      "home.role": "Attore",
      "headshot.eyebrow": "Headshot",
      "headshot.title": "Fotografia",
      ...
      "coaching.book": "Prenota una sessione",
      "meta.title.book": "Prenota una sessione — Luca Fontaine",
      "book.eyebrow": "Coaching",
      "book.title": "Prenota una sessione",
      "book.lede": "Raccontami il tuo progetto e cosa stai preparando. Le richieste inviate qui arrivano direttamente a me — non tramite il management — e ti risponderò personalmente.",
      "book.name": "Nome",
      "book.email": "Email",
      "book.project": "Progetto / produzione",
      "book.optional": "facoltativo",
      "book.service": "Di cosa hai bisogno?",
      "book.svc.dialect": "Coaching dialettale",
      "book.svc.audition": "Preparazione audizione & ruolo",
      "book.svc.selftape": "Preparazione self-tape",
      "book.svc.accent": "Riduzione dell'accento & dizione",
      "book.svc.speaking": "Public speaking",
      "book.svc.other": "Altro",
      "book.timeline": "Tempistiche / date preferite",
      "book.message": "Raccontami il progetto",
      "book.submit": "Invia richiesta",
      "coaching.video.eyebrow": "In evidenza",
      "coaching.video.label": "Luca Fontaine ospite di Live with Kelly and Mark.",
      ...
      "coaching.eyebrow": "Coaching",
      "coaching.title": "Coach di Dialetto e Recitazione",
      ...
      "contact.formbtn": "Scrivimi",
      "meta.title.cform": "Scrivimi — Luca Fontaine",
      "cform.eyebrow": "Contatti",
      "cform.title": "Scrivimi",
      "cform.lede": "Lasciami un messaggio e ti risponderò il prima possibile.",
      "cform.subject": "Oggetto",
      "cform.message": "Messaggio",
      "cform.submit": "Invia messaggio",
      "contact.mgmt": "Management",
      "contact.direct": "Diretto",
      "contact.profiles": "Profili",
      "footer.meta": "Attore • Autore • Coach"
    },
    ...
    fr: {
      ...
      "home.role": "Comédien",
      "headshot.eyebrow": "Headshots",
      "headshot.title": "Photographie",
      "resume.title": "CV",
      "approach.eyebrow": "Approche",
      "approach.title": "Ma Démarche",
      "approach.body": "[ Texte sur la démarche à venir — à fournir par Luca. ]",
      "coaching.book": "Réserver une séance",
      "meta.title.book": "Réserver une séance — Luca Fontaine",
      "book.eyebrow": "Coaching",
      "book.title": "Réserver une séance",
      "book.lede": "Parlez-moi de votre projet et de ce que vous préparez. Les demandes envoyées ici me parviennent directement — pas via mon management — et je vous répondrai personnellement.",
      "book.name": "Nom",
      "book.email": "E-mail",
      "book.project": "Projet / production",
      "book.optional": "facultatif",
      "book.service": "De quoi avez-vous besoin ?",
      "book.svc.dialect": "Coaching d'accent",
      "book.svc.audition": "Préparation d'audition & de rôle",
      "book.svc.selftape": "Préparation de self-tape",
      "book.svc.accent": "Réduction d'accent & diction",
      "book.svc.speaking": "Prise de parole en public",
      "book.svc.other": "Autre",
      "book.timeline": "Calendrier / dates souhaitées",
      "book.message": "Parlez-moi du projet",
      "book.submit": "Envoyer la demande",
      "coaching.video.eyebrow": "À la une",
      "coaching.video.label": "Luca Fontaine dans Live with Kelly and Mark.",
      ...
      "coaching.eyebrow": "Coaching",
      "coaching.title": "Coach d'accent et de jeu",
      ...
      "coaching.cta.btn": "Réserver une séance",
      ...
      "contact.formbtn": "Me contacter",
      "meta.title.cform": "Me contacter — Luca Fontaine",
      "cform.eyebrow": "Contact",
      "cform.title": "Me contacter",
      "cform.lede": "Laissez-moi un message et je vous répondrai dès que possible.",
      "cform.subject": "Objet",
      "cform.message": "Message",
      "cform.submit": "Envoyer le message",
      "contact.mgmt": "Management",
      "contact.direct": "Direct",
      "contact.profiles": "Profils",
      "footer.meta": "Comédien • Auteur • Coach"
    },
    ...
    es: {
      ...
      "coaching.book": "Reservar una sesión",
      "meta.title.book": "Reservar una sesión — Luca Fontaine",
      "book.eyebrow": "Coaching",
      "book.title": "Reservar una sesión",
      "book.lede": "Cuéntame sobre tu proyecto y lo que estás preparando. Las solicitudes enviadas aquí llegan directamente a mí — no a través del management — y te responderé personalmente.",
      "book.name": "Nombre",
      "book.email": "Correo electrónico",
      "book.project": "Proyecto / producción",
      "book.optional": "opcional",
      "book.service": "¿Qué necesitas?",
      "book.svc.dialect": "Coaching de dialectos",
      "book.svc.audition": "Preparación de audición y papel",
      "book.svc.selftape": "Preparación de self-tape",
      "book.svc.accent": "Reducción de acento y dicción",
      "book.svc.speaking": "Hablar en público",
      "book.svc.other": "Otro",
      "book.timeline": "Calendario / fechas preferidas",
      "book.message": "Cuéntame sobre el proyecto",
      "book.submit": "Enviar solicitud",
      "coaching.video.eyebrow": "Destacado",
      "coaching.video.label": "Luca Fontaine en Live with Kelly and Mark.",
      ...
      "coaching.eyebrow": "Coaching",
      "coaching.title": "Coach de Dialecto y Actuación",
      ...
      "contact.formbtn": "Contáctame",
      "meta.title.cform": "Contáctame — Luca Fontaine",
      "cform.eyebrow": "Contacto",
      "cform.title": "Contáctame",
      "cform.lede": "Déjame un mensaje y te responderé lo antes posible.",
      "cform.subject": "Asunto",
      "cform.message": "Mensaje",
      "cform.submit": "Enviar mensaje",
      "contact.mgmt": "Mánager",
      "contact.direct": "Directo",
      "contact.profiles": "Perfiles",
      "footer.meta": "Actor • Guionista • Coach"
    }
  };
